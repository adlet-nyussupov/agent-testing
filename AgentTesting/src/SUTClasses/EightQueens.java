...
public class EightQueens implements Runnable {
	...
	*/
	...
	public static char[][] blankBoard(int size){
	...
	public static boolean inbounds(int row, int col, char[][] mat){
	...
	*/
	public static boolean isSquare(char[][] mat)
	...
	*/
	public static boolean onlyContains(char[][] mat, char[] valid)
